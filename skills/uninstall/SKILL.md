...
5. Remove `$HOME/.claude/statusline-limits/` after settings are restored or cleaned up, including `statusline.mjs`, `limits-fetch.mjs`, `.extended-approved`, `cache.json`, and `prev-statusline.json`.
